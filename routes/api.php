...
use App\Http\Controllers\BudgetRangesController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/getLeadsByView', [LeadController::class, 'getLeadsByView']);
    ...
    Route::post('/email_marketing_getleads', [LeadController::class, 'email_marketing_getleads']);
    ...
    Route::post('/email-marketing/campaigns/update', [EmailCampaignController::class, 'updateCampaign']);
